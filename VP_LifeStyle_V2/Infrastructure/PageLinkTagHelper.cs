...
namespace VP_LifeStyle_V2.Infrastructure
{
    ...
    public class PageLinkTagHelper : TagHelper
    {
        ...
        //Ensures that the page increment and a new set of items/customers is added on.
        //Ensures that even when the search items/customer names are found, it returns them
        //According to the standard page number & size.
